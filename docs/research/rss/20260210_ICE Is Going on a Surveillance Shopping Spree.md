...
This reveals a massive expansion of state surveillance capabilities targeting vulnerable populations, with potential for widespread tracking, data collection, and systemic control mechanisms. The scale of funding suggests not just immigration enforcement, but the development of a comprehensive surveillance system that could be weaponized against broader populations.
